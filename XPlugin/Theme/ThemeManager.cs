        ...
        private static void ApplyThemeToControl(Control control)
        {
            try
            {
                switch (control)
                {
                    ...
                    case Label label:
                        if (label.ForeColor != Color.DarkBlue && label.ForeColor != Color.DarkGreen)
                        {
        ...
        public static ThemeConfig[] GetPredefinedThemes()
        {
            return new[]
            {
                ...
                new ThemeConfig
                {
                    ...
                    ListBackgroundColor = Color.FromArgb(230, 250, 230),
                    InputBackgroundColor = Color.White,
                    LogBackgroundColor = Color.FromArgb(0, 50, 0),
                    LogForegroundColor = Color.LightGreen
                },
                new ThemeConfig
                {
                    Name = "护眼模式",
                    BackgroundColor = Color.FromArgb(199, 237, 204),
                    ForegroundColor = Color.FromArgb(51, 51, 51),
                    ListBackgroundColor = Color.FromArgb(220, 245, 220),
                    InputBackgroundColor = Color.White,
                    LogBackgroundColor = Color.FromArgb(40, 60, 40),
                    LogForegroundColor = Color.LightGreen
                }
            };
        }
